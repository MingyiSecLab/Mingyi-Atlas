...
function abortActiveGoalJudge(state: TUIState): boolean {
  ...
  // pause. saveToThread is best-effort, so keep it fire-and-forget here.
...
export function setupAutocomplete(state: TUIState): void {
  const slashCommands: SlashCommand[] = [
    ...
    {
      name: 'goal',
      description: 'Set/manage persistent goal',
      getArgumentCompletions: (argumentPrefix: string) =>
        [
          ...
          { value: 'judge', label: 'judge', description: 'Set goal judge defaults' },
