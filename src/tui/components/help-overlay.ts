...
function getCommands(modes: number): HelpEntry[] {
  const cmds: HelpEntry[] = [
    ...
    { key: '/report-issue', description: 'Open or browse mingyi-atlas issues' },
    ...
    { key: '/goal', description: 'Set/manage persistent goal' },
    { key: '/goal judge', description: 'Set goal judge defaults' },
  ];
