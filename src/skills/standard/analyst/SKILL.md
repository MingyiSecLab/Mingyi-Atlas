...
| `/skills/standard/analyst/ssrf-analysis-analysis/SKILL.md`             | User-controlled URL reaches http client                        |
| `/skills/standard/analyst/deserialization-analysis-analysis/SKILL.md`  | pickle / Java ObjectInputStream / .NET BinaryFormatter / YAML  |
| `/skills/standard/analyst/ssti-analysis-analysis/SKILL.md`             | User input rendered by Jinja/Twig/Freemarker/Velocity          |
| `/skills/standard/analyst/xxe-analysis-analysis/SKILL.md`              | XML parser with external entity expansion enabled              |
...
| `/skills/standard/analyst/command-injection-analysis-analysis/SKILL.md`| User input → shell, exec, system                              |
| `/skills/standard/analyst/idor-analysis-analysis/SKILL.md`             | Missing authorization check on object reference                |
